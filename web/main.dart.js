...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var now = new A.DateTime(Date.now(), false);
      B.DivElement_methods.set$text(type$.DivElement._as(document.querySelector("#output")), "The time is " + A.Primitives_getHours(now) + ":" + A.Primitives_getMinutes(now) + " and your Dart web app is running!");
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.Rti, A._FunctionParameters, A._Type, A.DateTime, A.Null, A.StringBuffer]);
